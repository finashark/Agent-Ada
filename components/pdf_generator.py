...
try:
    ...
    FPDF_AVAILABLE = True
    logger.info("✅ fpdf2 library available")
except ImportError:
    FPDF_AVAILABLE = False
    logger.warning("⚠️ fpdf2 not installed. Run: pip install fpdf2")
...
class AgentAdaPDF(FPDF):
    ...
    def body_text(self, text: str):
        ...
        self.set_text_color(0, 0, 0)
        # Handle Vietnamese characters by encoding
    ...
    def generate_daily_report(
        ...
        if economic_calendar:
            ...
            for event in economic_calendar[:10]:
                ...
                safe_event = event_text.encode('latin-1', 'replace').decode('latin-1')
...
def render_pdf_download_button(
    report_data: Dict,
    button_label: str = "📥 Tải PDF Report",
    filename: str = None
):
    """
